...
class AppColors {
  ...
  static const Color secondary =
      Color(0xFF00C853); // Vert boutons "Commencer le test"

  // 📄 Backgrounds
  static const Color backgroundLight = Color(0xFFF5F5F5);
  static const Color cardBackground = Color(0xFFFFFFFF);
  static const Color beige =
      Color(0xFFFFF3E0); // Background illustration poumons
  ...
  // 🫁 Icônes spécifiques
  static const Color lungIcon =
      Color(0xFF5A9FA8); // Couleur des poumons dans l'illustration
